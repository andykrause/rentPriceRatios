...
#       #data.list[[j]] <- res$data
#     }
#     x.temp <- rbind.fill(lb.list)
#     x.temp$lga <- lgas[i]
#     lb.lga[[i]] <- x.temp
#   }
#   
#   good <- which(lapply(lb.lga, class) == 'data.frame')
#   lb.lga <- rbind.fill(lb.lga[good])
