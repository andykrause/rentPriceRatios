...
<<set.parameters, echo=FALSE, warning=FALSE, message=FALSE, comment=FALSE>>=
...
<<load.libraries, warning=FALSE, message=FALSE, echo=FALSE, comment=FALSE>>=
...
<<source.files, warning=FALSE, message=FALSE, echo=FALSE, comment=FALSE, cache=TRUE>>=
...
<<load.data, warning=FALSE, message=FALSE, echo=FALSE, comment=FALSE, cache=TRUE>>=

 ## Load workspace

  load(file.path('c:/code/research/rentPriceRatios/data/rprWrkspce.RData'))
