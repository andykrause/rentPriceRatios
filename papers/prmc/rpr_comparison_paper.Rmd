...
Depending on the discipline or use, the relationship between rents and prices may be referred to (and calculated as) 'price-to-rent ratio' [@Himmelberg2005; @glaeser2007arbitrage; @goetzmann2012subprime], 'rent-price ratio' [@Campbell2009; @bracke2015house], 'rental yield' [@fu2001market] and 'dividend price ratio' [@hwang2006dividend]. Within this study we will use the term `rent-price ratio.' Being expressed as such, the annual rental amount is the numerator and the sale price or home value is the denominator.
